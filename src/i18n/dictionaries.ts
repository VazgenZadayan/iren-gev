...
const ru: Dictionary = {
  ...
  invitation: {
    eyebrow: "Приглашение",
    title: "Приглашаем разделить нашу радость",
    body: "С большой радостью приглашаем вас разделить с нами день нашей свадьбы — праздник любви, семьи и близких друзей.",
  },
  details: {
    eyebrow: "Когда и где",
    title: "Празднование",
...
const hy: Dictionary = {
  ...
  invitation: {
    eyebrow: "Հրավեր",
    title: "Հրավիրում ենք կիսելու մեր օրը",
    body: "Մեծ սիրով հրավիրում ենք Ձեզ նշելու մեր կյանքի նոր սկիզբը՝ ընտանիքի և մտերիմ ընկերների հետ միասին:",
  },
  details: {
